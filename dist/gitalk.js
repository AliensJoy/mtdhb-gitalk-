...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_prop_types__ = __webpack_require__(80);
...
var _gitalk = __webpack_require__(90);
...
module.exports = __webpack_require__(87).polyfill();
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(10), __webpack_require__(88)))
...
module.exports = {"init":"留言板加载中 ...","no-found-related":"未找到相关的 %{link} 进行评论","please-contact":"请联系 %{user} 初始化创建","init-issue":"初始化 Issue","leave-a-comment":"请勿提交广告、谩骂等信息，否则一律拉黑；提建议或者 BUG 请点击页面顶部的“反馈问题”","comment":"留言","support-markdown":"支持 Markdown 语法","login-with-github":"使用 GitHub 登录","first-comment-person":"来做第一个留言的人吧！","commented":"发表于","load-more":"加载更多","counts":"%{counts} 条评论","sort-asc":"从旧到新排序","sort-desc":"从新到旧排序","logout":"注销","anonymous":"未登录用户"}
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement('div', { className: 'gt-comment-body markdown-body', dangerouslySetInnerHTML: {
          __html: isAdmin ? comment.body_html : ['WhiteBlackHacker', 'JantHsueh', 'SecutiryKail'].includes(comment.user && comment.user.login) ? '大家好，我是傻逼' : comment.body_html.replace(/助手|平台|公众号|出售|垃圾|支付宝|[微v威唯]信|WX|QQ|扫码|免费|加我|脑残|疯狗/img, '***')
        } })
    )
  );
};
